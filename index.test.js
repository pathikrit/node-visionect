...
check(
  ...
  ['Get device live view', visionect.view.device(uuid)],
  ['Get server live view', visionect.view.server(uuid)],
  ...
  ['Get server config', visionect.server.config()],
  ['Get server status', visionect.server.status()],
  ['Get server orphans', visionect.server.orphans()],
)
